...
class AddQuestion extends Component {
	...
	selectValue(event, index) {
		console.log("AddQuestion -> selectValue");
		...
		if(!previous_quesid_anstype[index]["option"])
		{
			previous_quesid_anstype[index]["options"] = {}
		}
	...
	onInputTextUpdate(value, index, position){
		console.log("AddQuestion -> onInputTextUpdate");
	...
	createNewForm(event) {
console.log(this.state.add_form, "in create")
   ...
   //  const show_form = (
  	...
  	// 	<div className="container" style={{border: "1px solid black", height: "100%"}}>
			...
			// 			<textarea className="textarea-style" type="text" name="question-title" rows="2" cols="50" 
			// 		  placeholder="Form Title" onBlur={this.props.saveQuestion}/>
			// 			<textarea className="textarea-style" type="text" name="question-description" rows="2" cols="50" 
			// 			placeholder="Please write the description as well." onBlur={this.saveQuestion}/>	
			// 			<div>
    	...
    	console.log(this.state.add_form, "in render")
		return(
			<div>
